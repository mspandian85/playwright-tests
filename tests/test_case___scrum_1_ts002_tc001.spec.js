...
test('Test Case - SCRUM-1 TS002 TC001',
async ({ page }) => {
    ...
    // 3. Enter invalid username in the Username field [Test Data- invalidAdmin] [Acceptance Criteria- AC2]

    await page.getByPlaceholder(
        'Username'
    ).fill('Admin');

    // 4. Enter valid password in the Password field [Test Data- validPassword123!] [Acceptance Criteria- AC2]
